...
async def copy_file(src: Path, dest_folder: Path):
    ...
    try:
        ...
        if dest_path.exists():
            print(Fore.RED + f"[SKIP] Файл {src} вже існує у {dest_folder}")
            return
